...
import io.ikanos.spec.openapi.OasExportBuilder;
import io.ikanos.spec.openapi.OasExportResult;
import io.ikanos.spec.openapi.OasYamlWriter;
...
@Command(
    ...
    description = "Export a Ikanos capability's REST adapter as an OpenAPI specification."
)
public class ExportOpenApiCommand implements Callable<Integer> {
    ...
    @Parameters(index = "0", description = "Path to the Ikanos capability YAML file")
    ...
    public Integer call() {
        try {
            ...
            IkanosSpec IkanosSpec = yamlMapper.readValue(capabilityFile, IkanosSpec.class);
            ...
            OasExportResult result = builder.build(IkanosSpec, adapter, specVersion);
