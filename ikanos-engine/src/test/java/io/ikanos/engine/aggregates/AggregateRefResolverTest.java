...
public class AggregateRefResolverTest {
    ...
    void resolveShouldSkipWhenNoAggregates() {
        IkanosSpec spec = new IkanosSpec("1.0.0-alpha1", null, new CapabilitySpec());
    ...
    void resolveShouldDeriveHintsOnMcpToolFromSemantics() {
        IkanosSpec spec = buildSpecWithMcpRef(
    ...
    private IkanosSpec buildSpecWithMcpRef(SemanticsSpec semantics,
