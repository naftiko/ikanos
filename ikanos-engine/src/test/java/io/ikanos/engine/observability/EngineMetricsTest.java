...
class EngineMetricsTest {
    ...
    void recordRequestShouldIncrementCounterAndRecordDuration() {
        ...
        assertTrue(hasMetric(data, "ikanos.request.total"),
                "Should record ikanos.request.total counter");
        assertTrue(hasMetric(data, "ikanos.request.duration.seconds"),
                "Should record ikanos.request.duration.seconds histogram");
    }
    ...
    void recordRequestErrorShouldIncrementErrorCounter() {
        ...
        Collection<MetricData> data = metricReader.collectAllMetrics();
        assertTrue(hasMetric(data, "ikanos.request.errors"),
                "Should record ikanos.request.errors counter");
    }
    ...
    void recordStepShouldRecordStepDuration() {
        ...
        Collection<MetricData> data = metricReader.collectAllMetrics();
        assertTrue(hasMetric(data, "ikanos.step.duration.seconds"),
                "Should record ikanos.step.duration.seconds histogram");
    }
    ...
    void recordHttpClientShouldIncrementCounterAndRecordDuration() {
        ...
        Collection<MetricData> data = metricReader.collectAllMetrics();
        assertTrue(hasMetric(data, "ikanos.http.client.total"),
                "Should record ikanos.http.client.total counter");
        assertTrue(hasMetric(data, "ikanos.http.client.duration.seconds"),
                "Should record ikanos.http.client.duration.seconds histogram");
    }
    ...
    void capabilityStartedShouldIncrementActiveGauge() {
        ...
        Collection<MetricData> data = metricReader.collectAllMetrics();
        assertTrue(hasMetric(data, "ikanos.capability.active"),
                "Should record ikanos.capability.active gauge");
    }
    ...
    void recordRequestShouldIncludeCorrectAttributes() {
        ...
        Collection<MetricData> data = metricReader.collectAllMetrics();
        MetricData requestTotal = findMetric(data, "ikanos.request.total");
    ...
    void recordHttpClientShouldIncludeStatusCodeAttribute() {
        ...
        Collection<MetricData> data = metricReader.collectAllMetrics();
        MetricData total = findMetric(data, "ikanos.http.client.total");
