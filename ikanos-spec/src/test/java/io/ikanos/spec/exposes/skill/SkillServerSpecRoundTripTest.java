...
public class SkillServerSpecRoundTripTest {
    ...
    public void setUp() throws Exception {
        ...
        IkanosSpec = mapper.readValue(file, IkanosSpec.class);

        schemaVersion = VersionHelper.getSchemaVersion();

        skillSpec = (SkillServerSpec) IkanosSpec.getCapability().getExposes().stream()
    ...
    public void testNaftikoVersionLoaded() {
        assertEquals(schemaVersion, IkanosSpec.getIkanos(), "ikanos version should be " + schemaVersion);
    }
