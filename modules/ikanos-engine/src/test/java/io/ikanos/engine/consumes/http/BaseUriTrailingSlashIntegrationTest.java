 ...
 * (YAML → IkanosSpec → HttpClientSpec setter), rather than silently producing malformed URLs at
 * runtime.
 */
public class BaseUriTrailingSlashIntegrationTest {
    ...
    public void deserializingYamlWithTrailingSlashBaseUriShouldFail() throws Exception {
        ...
        Exception wrapping = assertThrows(Exception.class, () -> mapper.readValue(fixture, IkanosSpec.class));
