...
import io.ikanos.spec.observability.ObservabilityTracesSpec;
import io.ikanos.spec.observability.ObservabilityExportersSpec;
import io.ikanos.spec.observability.ObservabilityOtlpExporterSpec;
...
public class TelemetryBootstrapTest {
    ...
    void initWithServiceNameShouldEnablePrometheusMetrics() {
        ...
        assertTrue(text.contains("ikanos_request_total"),
