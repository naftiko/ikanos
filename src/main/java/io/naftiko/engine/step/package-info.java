 ...
 * Embedders register {@link io.naftiko.engine.step.StepHandler} implementations by step name via
 * {@link io.naftiko.engine.step.StepHandlerRegistry}; when the engine encounters a registered step
